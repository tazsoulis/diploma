...
if(isset($_POST['email'])) {
  ...
  if(!preg_match($string_exp,$name)) {
    $error_message .= 'Το όνομα που πληκτρολογήσατε δεν είναι έγκυρο.<br />';
  }
  if(!preg_match($string_exp,$surname)) { 
    $error_message .= 'Το επώνυμο που πληκτρολογήσατε δεν είναι έγκυρο.<br />';
  }
  if(strlen($description) < 2) {
   $error_message .= 'Το κείμενο που πληκτρολογήσατε δεν είναι έγκυρο.<br />';
  } 
