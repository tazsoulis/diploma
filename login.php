		...
		<div class="small-12 medium-offset-3 medium-6 large-offset-3 large-6">
			<form action="confirm.php" method="post">
			  <fieldset>
				...
				<input name="username" type="text" placeholder="Το username σας">
				<label>Password</label>
				<input name="password" type="password" placeholder="Το password σας">
				Αν δεν είστε μέλος, μπορείτε πολύ απλα να γίνεται πατώντας το πλήκτρο <a href="http://mitroana.comuf.com/register.php">εδω! </a>
